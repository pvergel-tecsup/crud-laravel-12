    ...
    <form action="{{ route('categorias.update', [ 'id' => $categoria->id ]) }}" method="POST">
        ...
        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
            <div class="sm:col-span-2">
                ...
                <input type="text" name="descripcion" id="descripcion" placeholder="Descripción de categoría" maxlength="100" required value="{{ $categoria->descripcion }}" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-primary-500 dark:focus:border-primary-500">
            </div>
        </div>
